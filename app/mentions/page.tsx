      ...
      <div className="pt-24 px-4 max-w-4xl mx-auto">
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>Raison sociale&nbsp;: DevLeads - Jeff Bénard</li>
            <li>Statut juridique : 1000 - Entrepreneur individuel</li>
            <li>SIRET&nbsp;: [989 998 331 00015]</li>
            <li>Responsable éditorial&nbsp;: BÉNARD Jeff</li>
            <li>
              Adresse&nbsp;: 19 rue Normande, 27370 Le Thuit-de-l&apos;Oison,
              France
            </li>
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 text-sm opacity-80">
            Vercel opère un réseau mondial (edge) comprenant des points de
            présence en Europe.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p>
            ...
            sons, graphismes, logos, icônes, etc.) sont la propriété exclusive
            de DevLeads, sauf mentions contraires. Toute reproduction,
        ...
        <section className="mt-8 mb-16">
          ...
          <p>
            DevLeads s&apos;efforce de fournir des informations à jour, exactes
            et vérifiables. Toutefois, nous ne pouvons garantir
            l&apos;exhaustivité ni l&apos;actualisation permanente des contenus
            publiés. L&apos;utilisation du site se fait sous la seule
            responsabilité de l&apos;utilisateur. DevLeads ne pourra être tenue
            responsable des dommages directs ou indirects résultant de
            l&apos;accès ou de l&apos;usage du site (y compris
            l&apos;inaccessibilité, pertes de données, présence de virus, etc.).
          </p>
        </section>
      </div>
    </>
